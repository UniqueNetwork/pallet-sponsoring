...
use sp_runtime::{
	...
	ApplyExtrinsicResult, MultiSignature, ExtrinsicInclusionMode,
};
...
parameter_types! {
	...
	pub BlockWeights: frame_system::limits::BlockWeights =
		frame_system::limits::BlockWeights::simple_max(Weight::from_parts(1024, 5 * 1024 * 1024));
...
impl pallet_template::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type WeightInfo = pallet_template::weights::TemplateWeight<Runtime>;
}
...
construct_runtime!(
	pub enum Runtime {
		...
		Charging: pallet_template_transaction_payment,
