...
Template pallet contains call 'do_something' which demonstrate custom sponsoring logic.

Pallets transaction-payment and charge-transaction dedicated to define and bind custom logic for transaction.
File template/src/sponsorship.rs contains sponsoring logic for that pallet.  
Runtime must implement transaction-payment and charge-transaction pallets, SponsoringResolve trait and extension in SignedExtra.
